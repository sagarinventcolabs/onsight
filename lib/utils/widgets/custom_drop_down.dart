...
class CustomDropdownButton<T> extends StatefulWidget {
  ...
  ///
  /// Defaults to [MaterialColor.shade400] of [ColourConstants.grey] when the theme's
  /// [ThemeData.brightness] is [Brightness.light] and to
  /// [ColourConstants.white10] when it is [Brightness.dark]
  final Color? iconDisabledColor;

  /// The color of any [Icon] descendant of [icon] if this button is enabled,
  /// i.e. if [onChanged] is defined.
  ///
  /// Defaults to [MaterialColor.shade700] of [ColourConstants.grey] when the theme's
  /// [ThemeData.brightness] is [Brightness.light] and to
  /// [ColourConstants.white70] when it is [Brightness.dark]
    ...
    Widget result = DefaultTextStyle(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          border: Border.all(color: ColourConstants.grey300,width: 1),
            ...
            IconTheme(
              data: IconThemeData(
                color: Theme.of(context).brightness == Brightness.light
                    ? ColourConstants.grey700
                    : ColourConstants.white70,
