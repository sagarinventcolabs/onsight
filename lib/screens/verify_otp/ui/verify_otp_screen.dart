          ...
          body: SingleChildScrollView(
            child: Column(
              ...
              children: [
                  ...
                  child: Row(
                    children: [
                      Expanded(
                        flex: 4,
                        child: Padding(
                          padding: EdgeInsets.only(right: Dimensions.height4, top: Dimensions.height4, bottom: Dimensions.height4),
                          child: Container(
                            height: 59,
                            ...
                            child: CountryCodePicker(
                              enabled: false,
                              textStyle: TextStyle(
                                  color:Get.isDarkMode?ColourConstants.dark_mode_white: Colors.black,
                                  fontWeight: FontWeight.bold,
                                  fontSize: Dimensions.font16),
                              showFlagMain: false,
                              padding: EdgeInsets.zero,
                              dialogBackgroundColor: Get.isDarkMode?Colors.black:Colors.white,
                              dialogTextStyle: TextStyle(color: Get.isDarkMode?Colors.white:Colors.black),
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              enabledBorder: OutlineInputBorder(
                                borderSide: BorderSide(width: 1, color:Get.isDarkMode?Colors.white70: Colors.grey),
                              ),
                ...
                Padding(
                  padding: EdgeInsets.symmetric(horizontal: Dimensions.height25, vertical: Dimensions.height20),
                  child: TextField(
                      ...
                      Padding(
                        ...
                        child: Text(resendCode,
                            style: TextStyle(
                                ...
                                color: Get.isDarkMode?Colors.blue:ColourConstants.primary,
