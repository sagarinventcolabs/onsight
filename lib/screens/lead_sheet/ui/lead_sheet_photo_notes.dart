  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        bottomNavigationBar: Obx(()=>GestureDetector(
          onTap: () async {
            if(_uploadJobPhotosC.enableButton.isTrue) {
              ...
              controller.list[i].yetToSubmit = await manager.getYetToSubmitCount(controller.list[i].exhibitorId.toString(), controller.showNumber.value);
              controller.list.refresh();
              controller.selectedExhibitorModel.first = controller.list[i];
              ...
              defaultDialog(
                  Get.context!, title: key==smallUpdateStr?photosUpdatedSuccessfully:photosAddedSuccessfully,
                  cancelable: false,
                  onTap: () {
        ...
        body: Obx(() => ListView(
              ...
              children: [
                Text("You have selected ${_uploadJobPhotosC.photoList.length} photos to upload!",
          ...
          _uploadJobPhotosC.photoList[photoIndex].imagePath != null
              ? Stack(
                  children: [
                    GestureDetector(
                      onTap: (){
                        singleImageDialog(context: context, image: _uploadJobPhotosC.photoList[photoIndex].imagePath!);
                      },
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              image: DecorationImage(
                                  image: FileImage(File(_uploadJobPhotosC.photoList[photoIndex].imagePath!)),
                                  fit: BoxFit.fill),
                    ...
                    Positioned(
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          LeadSheetImageManager manager = LeadSheetImageManager();
                          var result = await manager.existOrNot(_uploadJobPhotosC.photoList[photoIndex].imageName.toString());
                          if(result.toString()=="true"){
                            LeadSheetImageModel dynamic = await manager.getImageByImageName(_uploadJobPhotosC.photoList[photoIndex].imageName.toString());
