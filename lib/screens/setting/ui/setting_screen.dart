        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Divider(),
              ExpansionTile(
                title: Text(performance,style: TextStyle(fontSize: Dimensions.font16,fontWeight: FontWeight.w600,color: Get.isDarkMode ? ColourConstants.white : ColourConstants.primary,)),
              ...
              Divider(),
              ExpansionTile(
                title: Text(utility,style: TextStyle(fontSize: Dimensions.font16,fontWeight: FontWeight.w600,color: Get.isDarkMode ? ColourConstants.white : ColourConstants.primary,)),
              ...
              ExpansionTile(
                title: Text(advancedSettings,style: TextStyle(fontSize: Dimensions.font16,fontWeight: FontWeight.w600,color: Get.isDarkMode ? ColourConstants.white : ColourConstants.primary,)),
