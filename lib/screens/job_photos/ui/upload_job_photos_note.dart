  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        bottomNavigationBar: Obx(()=>GestureDetector(
          onTap: () async {
            if(_uploadJobPhotosC.enableButton.isTrue) {
              ...
              controller.categoryList[i].listPhotos = await manager.getImageByCategoryIdandJobNumber(controller.categoryList[i].id.toString(), jobNumber);
              ...
              if (controller.categoryList[i].listPhotos!.isNotEmpty) {
                ...
                defaultDialog(Get.context!,
                    title: key == null ? addPhotos : key == smallUpdateStr
          ...
          child: Container(
            ...
            margin: EdgeInsets.only(left: Dimensions.width35, right: Dimensions.width35, bottom: Dimensions.height16),
            decoration: BoxDecoration(
                borderRadius: BorderRadius.all(Radius.circular(Dimensions.radius8)),
                color: _uploadJobPhotosC.enableButton.isTrue?ColourConstants.primary:ColourConstants.grey),
            child: Center(
                child: Text(
        ...
        body: Obx(() => ListView(
              ...
              children: [
                Text("You have selected ${_uploadJobPhotosC.jobPhotosList.length} photos to upload!",
     ...
     return StatefulBuilder(builder: (builderCtx,setState){
       return Scaffold(
         ...
         appBar: AppBar(actions: [GestureDetector(onTap: (){
           ...
           child: Icon(Icons.close,color: ColourConstants.white,size: Dimensions.height30,),
         ))],backgroundColor: ColourConstants.black,elevation: 0,automaticallyImplyLeading: false,),
         body: Container(
             ...
             child: PhotoViewGallery.builder(
               ...
               builder: (BuildContext context, int index) {
                 return PhotoViewGalleryPageOptions(
                     imageProvider: FileImage(File(_uploadJobPhotosC.jobPhotosList[index].imagePath??"")),
         ...
         bottomNavigationBar: Padding(
           ...
           child: Container(
             height: Dimensions.height50,
             margin: EdgeInsets.only(bottom: Dimensions.height35,top: Dimensions.height10),
             decoration: BoxDecoration(
          ...
          _uploadJobPhotosC.jobPhotosList[photoIndex].imagePath != null
              ? Stack(
                  children: [
                    GestureDetector(
                      onTap: (){
                        singleImageDialog(image: _uploadJobPhotosC.jobPhotosList[photoIndex].imagePath!, context: context);
                      },
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              image: DecorationImage(
                                  image: FileImage(File(_uploadJobPhotosC.jobPhotosList[photoIndex].imagePath!)),
                                  fit: BoxFit.fill),
                    ...
                    Positioned(
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          ImageManager manager = ImageManager();
                          var result = await manager.existOrNot(_uploadJobPhotosC.jobPhotosList[photoIndex].imageName.toString());
                          if(result.toString()=="true"){
                            ImageModel dynamic = await manager.getImageByImageName(_uploadJobPhotosC.jobPhotosList[photoIndex].imageName.toString());
      ...
      decoration: InputDecoration(
        ...
        suffixIcon: GestureDetector(
          ...
          child: Padding(
            ...
            child: _uploadJobPhotosC.jobPhotosList[photoIndex].isListening? Image.asset(
              Assets.icMicUnMute,
              height: Dimensions.height25,
              width: Dimensions.height25,
              color: Colors.blue,
