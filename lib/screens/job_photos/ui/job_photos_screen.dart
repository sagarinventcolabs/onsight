          ...
          child: GestureDetector(
            onTap: () async {
              ...
              if (_enableButton) {
                ...
                var response = await controller.getJobDetails(
                    jobEditingController.text.toString(),
                    false /*checkedValue*/,
                    true,
                    fromMain);
                analyticsFireEvent(jobPhotosModuleKey, input: {
                  ...
                  user: (sp?.getString(Preference.FIRST_NAME) ??
                      "") /*+"_"+(sp?.getString(Preference.LAST_NAME)??"")*/
                });
                if (response != null) {
                  if (!response.toString().contains(smallErrorStr) &
                      !response.toString().contains(noInternetStr)) {
                    Get.toNamed(Routes.jobUpdatesDetailScreen,
                        arguments: false /*checkedValue*/);
                  }
                }
                ...
                children: [
                  ...
                  GestureDetector(
                      ...
                      child: Get.isDarkMode
                          ? Image.asset(Assets.icJobPhotoDark,
                              height: Dimensions.height180)
                          : Image.asset(Assets.icTeamWork,
                              height:
                  ...
                  Row(
                    children: [
                      ...
                      Text(downloadJobsRelatedShow,
                          style: TextStyle(
                              color: Get.isDarkMode
                                  ? Colors.white
                                  : ColourConstants.textColour,
                              fontFamily: 'SFUI',
